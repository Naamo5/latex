...
%
% \begin{equation}
%   \overrightarrow{\tau} + \overrightarrow{AS} \wedge \overrightarrow{f} + m_1 \overrightarrow{AG_1} \times \overrightarrow{g} + K \ast \overrightarrow{\Omega}_{1/2} + \Lambda \ast \overrightarrow{\alpha}_{1/2} = I_{2, A} \ast \overrightarrow{\alpha}_{2/0} + \overrightarrow{\Omega}_{2/0} \times (I_{2, A} \ast \overrightarrow{\Omega}_{2/0})
...
\begin{figure}[H]
\centering
   \includestandalone[width=10cm]{../diagrams/2_bodies}%     without .tex extension
   % or use \input{mytikz}
