...
\draw[dash dot] (0,0) -- (-2.55,0) node[above]{$\overrightarrow{y_1}$};
\draw[dash dot] (0,0) -- (-2.5, -.42) node[below right]{$\overrightarrow{y_2}$};
\draw[thick] (-2, -0.35) arc (17:10:-3cm);
\node[] at (-2.9, -.2) {$\theta_{1/2, x}$};
...
\node[rotate=10] at (-2.8,-3.2) {$m_2$, $I_{2,A}$};
