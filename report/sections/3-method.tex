...
\centering
\includegraphics[scale=0.25]{\main/figures/load_free_position.pdf}
\caption{Position of the \ac{TCP} over time}
\label{fig:method:position}
\end{subfigure}
\begin{subfigure}{\textwidth}
\centering
\includegraphics[scale=0.25]{\main/figures/load_free_orientation.pdf}
...
The \ac{RMSD} model strongly depends on a good estimation of the spring constant and damper coefficient.

\begin{figure}
  \centering
  \includegraphics[scale=0.5]{\main/figures/suction_cup.jpg}
  \caption{. Image from \cite{Piab2020}.}
  \label{fig:method:butter}
\end{figure}
